...
st.markdown("<div style=\"position:fixed;right:16px;bottom:16px;width:280px;background:rgba(255,255,255,0.88);border:1px solid rgba(46,90,136,0.12);border-radius:14px;box-shadow:0 8px 22px rgba(46,90,136,0.10);padding:12px 14px;font-size:12.5px;line-height:1.4;color:#1b365d;z-index:999;\"><div style=\"font-weight:800;color:#2e5a88;margin-bottom:4px;\">교회 매칭 프로그램</div><div>팀 번호 + 이름(가나다순, “/” 구분) • 균형 매칭</div><div style=\"margin-top:6px;color:#6b7a90\">필수 컬럼: 이름, 성별(남/여), 교회 이름, 나이 · 결과는 팀 번호 + 이름(가나다순, / 구분) 만 표시됩니다.</div></div>", unsafe_allow_html=True)
